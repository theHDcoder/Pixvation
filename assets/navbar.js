document.addEventListener('DOMContentLoaded', () => {
    ...
    // Fixed offset value - space from top of viewport to section heading
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            if (targetSection) {
                ...
                // Special handling for home section - no offset (scroll to very top)
                const offset = targetId === '#home' ? 100 : SCROLL_OFFSET;

                // Calculate target position - section top minus offset
